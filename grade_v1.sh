...
function compile_and_run
{
    ...
    # run the program
    # test1
    ./$2 -f data/example1_k2_m10.txt -k 2 -i 100 > test1 2>&1
    ...
    #test2
    ./$2 -f data/example2_k3_m30.txt -k 3 -i 100 > test2 2>$1
    ...
    ./$2 -f data/example3_k5_m500.txt -k 5 -i 100 > test3 2>$1
    ...
    #test4
    ./$2 -f data/example4_*.txt -k 5 -i 100 > test4 2>&1
    ...
    #test5
    ./$2 -f data/example5_*.txt -k 4 -i 100 > test5 2>&1
    ...
    #test6
    ./$2 -f data/example6_*.txt -k 5 -i 100 > test6 2>&1
